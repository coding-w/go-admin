...
func (i *initCasbin) MigrateTable() error {

	return global.GA_DB.AutoMigrate(&adapter.CasbinRule{})
}

func (i *initCasbin) TableCreated() bool {
...
func (i *initCasbin) DataInserted() bool {
	if errors.Is(global.GA_DB.Where(adapter.CasbinRule{Ptype: "p", V0: "9528", V1: "/user/getUserInfo", V2: "GET"}).
